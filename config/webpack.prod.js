...
module.exports = merge(common, {
  ...
  output: {
    ...
    path: path.resolve(__dirname, "../dist"), //빌드되는 파일이 만들어지는 위치, __dirname: 현재 디렉토리, 어디에 결과가 저장되는지에 관한 것.
    publicPath:"./", // 얜 앞에 . 있어야함. / 얘만 쓰면 렌더링이 안됨, publicPath는 webpack plugins(ulr-loader, file-loader같은) css나 html 파일 안에 url들을 업데이트 해주기 위한 것(prefix개념)
    clean: true,
  },
  // 로더 설정
  module: {
